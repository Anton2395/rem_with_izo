...
list_data = [
    {"name": "p1101", "start": 0, "type": "int", 'table': 'real', "itarable": True, 'divide': True, 'if_change': False, 'byte_bind': 168, 'bit_bind':0},
    {"name": "p1201", "start": 2, "type": "int", 'table': 'real', "itarable": True, 'divide': True, 'if_change': False, 'byte_bind': 168, 'bit_bind':0},
    {"name": "p1202", "start": 4, "type": "int", 'table': 'real', "itarable": True, 'divide': True, 'if_change': False, 'byte_bind': 168, 'bit_bind':0},
    {"name": "p1301", "start": 6, "type": "int", 'table': 'real', "itarable": True, 'divide': True, 'if_change': False, 'byte_bind': 168, 'bit_bind':0},
    {"name": "p1302", "start": 8, "type": "int", 'table': 'real', "itarable": True, 'divide': True, 'if_change': False, 'byte_bind': 168, 'bit_bind':0},
    {"name": "p1401", "start": 10, "type": "int", 'table': 'real', "itarable": True, 'divide': True,
     'if_change': False, 'byte_bind': 168, 'bit_bind':0},
...
list_data_not_speed_s300_low_limits_warn = [
    {'name': 'low_limit_warning_%s' % i['name'], 'start': (100 * int(k) + 14), 'type': 'real', 'table': 'real',
     "itarable": False, 'divide': False, 'if_change': True} for k, i in enumerate(list_data) if i['itarable']]
